  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-3xl mx-auto">
        <p className="text-sage font-medium text-sm tracking-wide uppercase mb-3">
          Welcome
        </p>
        <h1 className="font-display text-5xl font-bold text-bark leading-tight mb-6">
          Cassandra Newell
        </h1>
        ...
        <div className="mt-8 h-px bg-gradient-to-r from-terracotta via-clay to-transparent" />
      </div>
    </section>
  );
}
